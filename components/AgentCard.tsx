...
const AgentCard: React.FC<AgentCardProps> = ({ agent }) => {
    ...
    return (
        <div className="bg-brand-secondary rounded-lg shadow-lg p-6 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 flex flex-col justify-between">
            <div>
